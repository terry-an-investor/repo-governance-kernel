...
COMMAND_MAP = {
    ...
    "audit-task-contracts": SCRIPTS / "audit_task_contracts.py",
    ...
    "open-task-contract": SCRIPTS / "open_task_contract.py",
    ...
    "rewrite-open-task-contract": SCRIPTS / "rewrite_open_task_contract.py",
    ...
    "update-task-contract-status": SCRIPTS / "update_task_contract_status.py",
