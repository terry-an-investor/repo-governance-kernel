...
PUBLIC_FLOW_BETA_STATUS = "b1"
PUBLIC_FLOW_FORWARD_CANDIDATE_STATUS = "candidate"
...
def describe_public_flow_contract_catalog() -> dict[str, object]:
    ...
    return {
        ...
        "candidate_status": PUBLIC_FLOW_FORWARD_CANDIDATE_STATUS,
        ...
        "notes": [
            "this catalog describes the current b1 stable field contract for the four public flow entrypoints",
            ...
            "candidate_subcontracts describe the remaining forward-looking evidence-layer response kernels that are still explicit owner-layer hardening candidates, not part of the current stable promise",
        ],
    }
