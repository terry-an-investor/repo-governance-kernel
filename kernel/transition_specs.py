...
WRITE_TARGET_SPECS: tuple[WriteTargetSpec, ...] = (
    ...
    WriteTargetSpec("control:constitution", "projection", "projection", ("control:constitution",)),
...
TRANSITION_SIDE_EFFECT_SPECS: tuple[TransitionSideEffectSpec, ...] = (
    ...
    TransitionSideEffectSpec("write_bootstrap_constitution", ("control:constitution",), projection_owners=("control:constitution",)),
    ...
    TransitionSideEffectSpec(
        "install_repo_local_hooks",
        ("support:repo-hooks",),
        projection_owners=("support:repo-hooks",),
    ),
    TransitionSideEffectSpec(
        "create_repo_bootstrap_support_scaffolding",
        ("support:repo-bootstrap",),
        projection_owners=("support:repo-bootstrap",),
    ),
    TransitionSideEffectSpec(
...
COMMAND_EXECUTOR_FIELD_SPECS: tuple[CommandExecutorFieldSpec, ...] = (
    ...
    CommandExecutorFieldSpec("bootstrap-repo", "skip_hooks", "skip-hooks", "bool"),
...
BUNDLE_EXECUTOR_FIELD_SPECS: tuple[BundleExecutorFieldSpec, ...] = (
    ...
    BundleExecutorFieldSpec("onboard-repo", "workspace_root", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "bootstrap_skip_hooks", "bool"),
    BundleExecutorFieldSpec("onboard-repo", "objective_title", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "objective_summary", "scalar"),
    BundleExecutorFieldSpec("onboard-repo", "objective_problem", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "objective_success_criterion", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "objective_non_goal", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "objective_why_now", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "objective_phase", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "objective_path", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "round_title", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "round_scope_item", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "round_scope_path", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "round_deliverable", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "round_validation_plan", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "task_title", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "task_summary", "scalar"),
    BundleExecutorFieldSpec("onboard-repo", "task_intent", "scalar", required=True),
    BundleExecutorFieldSpec("onboard-repo", "task_path", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "task_allowed_change", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "task_forbidden_change", "list", required=True),
    BundleExecutorFieldSpec("onboard-repo", "task_completion_criterion", "list", required=True),
...
BUNDLE_GOVERNANCE_SPECS: tuple[BundleGovernanceSpec, ...] = (
    ...
    BundleGovernanceSpec(
        name="onboard-repo",
        bundle_kind="executor-wrapper",
        purpose="Bootstrap one governed host repo and open the first honest objective, round, task-contract, and anchor state without leaving the user to hand-author the initial control surface.",
        composed_commands=(
            "bootstrap-repo",
            "open-objective",
            "set-phase",
        ...
        required_validations=("scripts/smoke_repo_onboarding.py", "scripts/smoke_kernel_bootstrap.py"),
    ),
    BundleGovernanceSpec(
...
BUNDLE_ROUTE_STATE_SPECS: tuple[BundleRouteStateSpec, ...] = (
    ...
    BundleRouteStateSpec("onboard-repo", "start", required_payload_keys=("workspace_root", "objective_title", "objective_problem", "objective_success_criterion", "objective_non_goal", "objective_why_now", "objective_phase", "objective_path", "round_title", "round_scope_item", "round_scope_path", "round_deliverable", "round_validation_plan", "task_title", "task_intent", "task_path", "task_allowed_change", "task_forbidden_change", "task_completion_criterion")),
    BundleRouteStateSpec("onboard-repo", "bootstrapped"),
    BundleRouteStateSpec("onboard-repo", "objective_opened"),
    BundleRouteStateSpec("onboard-repo", "execution_ready"),
    BundleRouteStateSpec("onboard-repo", "task_opened"),
    BundleRouteStateSpec("onboard-repo", "anchor_refreshed", terminal=True),
...
BUNDLE_STEP_TEMPLATE_SPECS: tuple[BundleStepTemplateSpec, ...] = (
    ...
    BundleStepTemplateSpec(
        ...
        command_name="bootstrap-repo",
        label="bootstrap governed host repo",
        bindings=(
            BundleStepBindingSpec("skip_hooks", "bootstrap_skip_hooks", "bool"),
        ),
    ),
    BundleStepTemplateSpec(
        bundle_name="onboard-repo",
        from_state="bootstrapped",
        to_state="objective_opened",
        command_name="open-objective",
        label="open first objective",
        bindings=(
            BundleStepBindingSpec("title", "objective_title"),
            BundleStepBindingSpec("summary", "objective_summary"),
            BundleStepBindingSpec("problem", "objective_problem"),
            BundleStepBindingSpec("success_criterion", "objective_success_criterion", "list"),
            BundleStepBindingSpec("non_goal", "objective_non_goal", "list"),
            BundleStepBindingSpec("why_now", "objective_why_now"),
            BundleStepBindingSpec("phase", "objective_phase"),
            BundleStepBindingSpec("path", "objective_path", "list"),
        ),
    ),
    BundleStepTemplateSpec(
        bundle_name="onboard-repo",
        from_state="objective_opened",
        to_state="execution_ready",
        command_name="set-phase",
        label="enter execution and open first round",
        static_scalar_fields=(("phase", "execution"), ("reason", "The first governed host objective now needs one bounded execution round for onboarding.")),
        static_bool_fields=(("auto_open_round", True),),
        bindings=(
            BundleStepBindingSpec("round_title", "round_title"),
            BundleStepBindingSpec("round_scope_item", "round_scope_item", "list"),
            BundleStepBindingSpec("round_scope_path", "round_scope_path", "list"),
            BundleStepBindingSpec("round_deliverable", "round_deliverable"),
            BundleStepBindingSpec("round_validation_plan", "round_validation_plan"),
        ),
    ),
    BundleStepTemplateSpec(
        bundle_name="onboard-repo",
        from_state="execution_ready",
        to_state="task_opened",
        command_name="open-task-contract",
        label="open first task contract",
        bindings=(
            BundleStepBindingSpec("title", "task_title"),
    ...
    BundleStepTemplateSpec(
        bundle_name="onboard-repo",
        from_state="task_opened",
        to_state="anchor_refreshed",
        command_name="refresh-anchor",
        label="refresh anchor to governed host workspace",
...
TRANSITION_COMMAND_SPECS: tuple[TransitionCommandSpec, ...] = (
    ...
    TransitionCommandSpec(
        ...
        guard_codes=("git_repository_available",),
        write_targets=(
            "control:constitution",
            "control:pivot-log",
            "control:exception-ledger",
        ...
        side_effect_codes=(
            "write_bootstrap_constitution",
            "refresh_pivot_log_projection",
            "refresh_exception_ledger_projection",
            "refresh_current_task_control_locator",
            "install_repo_local_hooks",
            "create_repo_bootstrap_support_scaffolding",
        ),
        projection_owners=("control:constitution", "control:pivot-log", "control:exception-ledger", "support:repo-hooks", "support:repo-bootstrap"),
        durable_owners=("current:current-task",),
        live_inspection_owners=("workspace:git-status",),
...
def validate_transition_specs() -> None:
    ...
    valid_write_target_surfaces = {"durable", "projection", "current", "support", "artifact", "snapshot", "event"}
