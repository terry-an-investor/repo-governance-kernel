...
- The canonical-doc migration now also updates the active pivot durable reference surface, so the round boundary must cover projects/session-memory/memory/pivots before the docs/canonical path swap is finalized.
- paths
