...
- `docs/canonical/ARCHITECTURE.md`: how the repo is split between kernel and sample
...
- `docs/canonical/IMPLEMENTATION_PLAN.md`: current implementation direction from `0.1.0a4` toward beta freeze
- `docs/canonical/PUBLIC_ALPHA_SURFACE.md`: current `0.1.0a4` public package entrypoints, unchanged from the set first frozen in `0.1.0a3`
