---
id: trans-2026-03-24-225259-rewrite-open-round-rewrote-round-round-2026-03-24-2110-stabilize-package-first-single-assessment-alpha-surface
...
- The state-root migration also repairs the derived-index contract read surface, so the active round must cover index alongside the runtime and canonical docs it now describes.
- paths
