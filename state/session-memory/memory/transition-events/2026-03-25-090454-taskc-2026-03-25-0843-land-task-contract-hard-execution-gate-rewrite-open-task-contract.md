---
id: trans-2026-03-25-090454-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-25-0843-land-task-contract-hard-execution-gate
...
confidence: high
created_at: 2026-03-25T09:04:54+08:00
...
task contract `taskc-2026-03-25-0843-land-task-contract-hard-execution-gate` remained `active` with fields paths pending rewrite

## Next State

task contract `taskc-2026-03-25-0843-land-task-contract-hard-execution-gate` still remains `active` after rewriting paths
...
- Include uv.lock in the release-cut execution boundary so version metadata and the lockfile do not drift.
- paths
