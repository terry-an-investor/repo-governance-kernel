...
- updated durable round contract `session-memory/memory/rounds/2026-03-23-2315-make-current-task-workspace-anchor-semantics-explicitly-snapshot-based.md`
...
- uv run python scripts/assemble_context.py --project-id session-memory --memory-limit 5 --output artifacts/session-memory/current-task-snapshot-anchor-context.md
