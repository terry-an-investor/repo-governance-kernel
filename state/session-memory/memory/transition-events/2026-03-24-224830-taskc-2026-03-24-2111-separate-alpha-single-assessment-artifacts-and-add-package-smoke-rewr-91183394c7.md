---
id: trans-2026-03-24-224830-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-24-2111-separate-alpha-single-assessment-artifacts-and-add-package-smoke
...
confidence: high
created_at: 2026-03-24T22:48:30+08:00
updated_at: 2026-03-24T22:48:30+08:00
supersedes: []
superseded_by: []
---
...
- The state-root migration is now real, so the active task must drop the retired projects tree and explicitly target state/<project_id> as the only live host-state layout.
- summary
- intent
- allowed_changes
- completion_criteria
