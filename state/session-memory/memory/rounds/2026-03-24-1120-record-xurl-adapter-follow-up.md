...
Canonical plan explicitly tracks xurl as an optional external session adapter follow-up without collapsing governance into it.

## Scope

- Record xurl-based external session extraction as a future adapter-layer todo in canonical planning docs.
...
- The note could overclaim xurl as governance infrastructure instead of constraining it to an evidence-adapter role.
