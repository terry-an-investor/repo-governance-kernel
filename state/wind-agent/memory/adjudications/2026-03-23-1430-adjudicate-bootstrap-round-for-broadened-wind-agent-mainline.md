...
- [warning] constitution/constitution_placeholder: control/constitution.md exists, but it is still a placeholder and does not restore real project invariants yet | evidence: C:\Users\terryzzb\Desktop\session-memory\state\wind-agent\control\constitution.md
