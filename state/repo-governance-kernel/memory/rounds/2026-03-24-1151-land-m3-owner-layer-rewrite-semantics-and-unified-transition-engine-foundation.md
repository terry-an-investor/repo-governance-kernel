...
paths:
  ...
  - state/repo-governance-kernel/memory/
  - CONTROL_SYSTEM.md
...
- Physically separate reusable governance runtime modules into kernel/ while keeping sample project data under state/repo-governance-kernel/.
