...
uv run python scripts/render_live_workspace_projection.py --project-id repo-governance-kernel --output artifacts/repo-governance-kernel/live-workspace-split-check.md
uv run python scripts/capture_handoff.py --project-id repo-governance-kernel --slug split-live-workspace-handoff-final2 --artifact-dir artifacts/repo-governance-kernel/split-live-workspace-handoff-final2
