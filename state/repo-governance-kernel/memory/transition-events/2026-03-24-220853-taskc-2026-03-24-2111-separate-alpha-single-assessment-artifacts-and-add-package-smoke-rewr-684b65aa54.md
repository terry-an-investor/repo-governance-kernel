---
id: trans-2026-03-24-220853-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-24-2111-separate-alpha-single-assessment-artifacts-and-add-package-smoke
...
- The root markdown migration now also repairs one historical snapshot reference before deleting the old root evaluation docs, so the task must cover snapshots as part of the same cleanup.
- paths
