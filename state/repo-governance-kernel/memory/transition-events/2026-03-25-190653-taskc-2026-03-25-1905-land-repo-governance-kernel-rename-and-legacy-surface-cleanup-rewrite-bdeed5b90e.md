---
id: trans-2026-03-25-190653-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-25-1905-land-repo-governance-kernel-rename-and-legacy-surface-cleanup
...
confidence: high
created_at: 2026-03-25T19:06:53+08:00
updated_at: 2026-03-25T19:06:53+08:00
supersedes: []
superseded_by: []
---
...
task contract `taskc-2026-03-25-1905-land-repo-governance-kernel-rename-and-legacy-surface-cleanup` remained `active` with fields paths pending rewrite

## Next State

task contract `taskc-2026-03-25-1905-land-repo-governance-kernel-rename-and-legacy-surface-cleanup` still remains `active` after rewriting paths
...
- The active task contract must explicitly cover index documentation because the rename cleanup changed index/README.md too.
- paths
