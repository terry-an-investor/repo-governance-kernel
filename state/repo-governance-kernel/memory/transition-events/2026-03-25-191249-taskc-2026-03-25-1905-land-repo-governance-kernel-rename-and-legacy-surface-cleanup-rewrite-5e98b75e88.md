---
id: trans-2026-03-25-191249-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-25-1905-land-repo-governance-kernel-rename-and-legacy-surface-cleanup
...
- The task contract path scope should use the real dot-prefixed directory names for repo-owned hook and CI surfaces.
- paths
