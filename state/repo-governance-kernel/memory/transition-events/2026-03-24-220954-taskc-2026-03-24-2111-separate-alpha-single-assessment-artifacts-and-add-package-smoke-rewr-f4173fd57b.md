---
id: trans-2026-03-24-220954-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-24-2111-separate-alpha-single-assessment-artifacts-and-add-package-smoke
...
confidence: high
created_at: 2026-03-24T22:09:54+08:00
...
- The active task has finished migrating the weakly-coupled root docs into docs/, so the task path set should drop the retired root doc names and keep only the live docs tree and real reference consumers.
- paths
