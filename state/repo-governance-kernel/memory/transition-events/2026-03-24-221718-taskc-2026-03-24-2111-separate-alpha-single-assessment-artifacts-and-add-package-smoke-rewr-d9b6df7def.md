---
id: trans-2026-03-24-221718-rewrite-open-task-contract-rewrote-task-contract-taskc-2026-03-24-2111-separate-alpha-single-assessment-artifacts-and-add-package-smoke
...
confidence: high
created_at: 2026-03-24T22:17:18+08:00
...
- The active task now also needs to make the smoke layer Python 3.11-compatible for GitHub Actions by fixing the shared fixture cleanup helper and the remaining snapshot/adoption smokes that still use shutil.rmtree onexc.
- paths
