...
- uv run python scripts/render_live_workspace_projection.py --project-id repo-governance-kernel --output artifacts/repo-governance-kernel/registry-owner-layer-live-workspace.md => artifact written
- uv run python scripts/create_snapshot.py --project-id repo-governance-kernel --slug registry-owner-layer-check --output artifacts/repo-governance-kernel/registry-owner-layer-snapshot.md => artifact written
- uv run python scripts/capture_handoff.py --project-id repo-governance-kernel --slug registry-owner-layer-handoff --artifact-dir artifacts/repo-governance-kernel/registry-owner-layer-handoff => packet captured
